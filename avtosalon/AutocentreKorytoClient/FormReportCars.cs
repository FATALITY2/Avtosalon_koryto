    ...
    public partial class FormReportCars : Form
    {
        ...
        private void buttonMake_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dataSource = logic.GetCars(new ReportBindingModel
                {
                    DateFrom = dateTimePickerFrom.Value,
                    DateTo = dateTimePickerTo.Value
                });
                ReportDataSource source = new ReportDataSource("DataSetCar", dataSource);
        ...
        private void buttonToEmail_Click(object sender, EventArgs e)
        {
            ...
            using (var dialog = new SaveFileDialog { Filter = "pdf|*.pdf" })
            {
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        logic.SaveCarToPdfFile(new ReportBindingModel
                        {
